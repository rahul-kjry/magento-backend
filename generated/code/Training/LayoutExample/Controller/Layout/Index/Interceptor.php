...
class Interceptor extends \Training\LayoutExample\Controller\Layout\Index implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNodeHtml');
        return $pluginInfo ? $this->___callPlugins('getNodeHtml', func_get_args(), $pluginInfo) : parent::getNodeHtml();
    }
}
