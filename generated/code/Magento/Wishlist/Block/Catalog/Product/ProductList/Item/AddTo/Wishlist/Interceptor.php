...
class Interceptor extends \Magento\Wishlist\Block\Catalog\Product\ProductList\Item\AddTo\Wishlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistHelper');
        return $pluginInfo ? $this->___callPlugins('getWishlistHelper', func_get_args(), $pluginInfo) : parent::getWishlistHelper();
    }
