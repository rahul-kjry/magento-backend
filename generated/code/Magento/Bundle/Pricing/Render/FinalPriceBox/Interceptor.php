...
class Interceptor extends \Magento\Bundle\Pricing\Render\FinalPriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showRangePrice');
        return $pluginInfo ? $this->___callPlugins('showRangePrice', func_get_args(), $pluginInfo) : parent::showRangePrice();
    }
