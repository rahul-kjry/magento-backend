...
class Interceptor extends \Magento\Contact\Block\ContactForm implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormAction');
        return $pluginInfo ? $this->___callPlugins('getFormAction', func_get_args(), $pluginInfo) : parent::getFormAction();
    }
