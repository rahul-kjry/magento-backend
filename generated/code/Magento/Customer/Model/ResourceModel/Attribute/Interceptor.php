...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Attribute implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getScopeValues(\Magento\Eav\Model\Attribute $object)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getScopeValues', func_get_args(), $pluginInfo) : parent::getScopeValues($object);
    }
    ...
    public function getUsedInForms(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getUsedInForms', func_get_args(), $pluginInfo) : parent::getUsedInForms($object);
    }
