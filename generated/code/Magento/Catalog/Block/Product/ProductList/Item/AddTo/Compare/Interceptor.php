...
class Interceptor extends \Magento\Catalog\Block\Product\ProductList\Item\AddTo\Compare implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCompareHelper');
        return $pluginInfo ? $this->___callPlugins('getCompareHelper', func_get_args(), $pluginInfo) : parent::getCompareHelper();
    }
