...
class Interceptor extends \Magento\Catalog\Model\Product\Link implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useRelatedLinks');
        return $pluginInfo ? $this->___callPlugins('useRelatedLinks', func_get_args(), $pluginInfo) : parent::useRelatedLinks();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useUpSellLinks');
        return $pluginInfo ? $this->___callPlugins('useUpSellLinks', func_get_args(), $pluginInfo) : parent::useUpSellLinks();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useCrossSellLinks');
        return $pluginInfo ? $this->___callPlugins('useCrossSellLinks', func_get_args(), $pluginInfo) : parent::useCrossSellLinks();
    }
    ...
    public function getAttributeTypeTable($type)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAttributeTypeTable', func_get_args(), $pluginInfo) : parent::getAttributeTypeTable($type);
    }
    ...
    public function getLinkCollection()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLinkCollection', func_get_args(), $pluginInfo) : parent::getLinkCollection();
    }
    ...
    public function getAttributes($type = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAttributes', func_get_args(), $pluginInfo) : parent::getAttributes($type);
    }
